...
%\begin{figure}
%  \centering
%  \includegraphics[width=3.3in]{fig/median-scale-scenes.eps}\\
%  \caption{Median-scale field experiment scenes.}\label{fg-median-scale-scenes}
%\end{figure}
%\begin{figure}
%  \centering
%  \includegraphics[width=3.3in]{fig/median-scale-chart.eps}\\
%  \caption{Median-scale field experiment results.}\label{fg-median-scale-chart}
%\end{figure}
\begin{table}
\begin{center}
...
\begin{center}
    ...
    \hline
    \multicolumn{2}{ |c| }{Standard} & \multicolumn{2}{ c| }{Complementary Filter} \\ \hline
...
%\begin{figure}
%  \centering
%  \includegraphics[width=3.3in]{fig/large-scale-campus-map.eps}\\
%  \caption{Campus map to large-scale field experiment results.}\label{large-scale-campus-map}
%\end{figure}
%\begin{figure}
%  \centering
%  \includegraphics[width=3.3in]{fig/large-scale-building5-map.eps}\\
%  \caption{Zoom in Engineering Building 5 map to large-scale field experiment results.}\label{large-scale-building5-map}
%\end{figure}
